...
Todas as transações são processadas com segurança através do **Google Play Billing** ou do **sistema de compras dentro do aplicativo da Apple**.
...
O Google e a Apple apenas nos fornecem identificadores de transação anônimos e informações de status (por exemplo, confirmação de compra ou reembolso) para que possamos disponibilizar o conteúdo adquirido.
