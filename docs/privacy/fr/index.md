...
Toutes les transactions sont traitées de manière sécurisée via **Google Play Billing** ou le **système d’achat intégré d’Apple**.
...
Google et Apple ne nous fournissent que des identifiants de transaction anonymisés et des informations sur l’état de la transaction (par exemple, confirmation d’achat ou remboursement) afin de livrer le contenu acheté.
...
Pour plus d’informations sur la manière dont Apple traite vos données de paiement, veuillez consulter la [Politique de confidentialité d’Apple](https://www.apple.com/legal/privacy/).
