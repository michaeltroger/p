...
Todas las transacciones se procesan de forma segura a través de **Google Play Billing** o el **sistema de compras dentro de la aplicación de Apple**.
...
Google y Apple solo nos proporcionan identificadores de transacción anonimizados e información sobre el estado (por ejemplo, confirmación de compra o reembolso) para poder entregar el contenido adquirido.
...
Para obtener más información sobre cómo Apple procesa sus datos de pago, consulte la [Política de Privacidad de Apple](https://www.apple.com/legal/privacy/).
